...
Dans cette perspective une discution est née entre Tom Beauchamp et Jame Childress, ceci étant de confession réligieuse différente les discutions on donnée lieux à des débats consigné dans le livre \textit{Les principes de l'éthique biomédicale} qui évolue est en est à sa 5e version (unique traduction française).
...
L'opensource permet de se passer du tiers de confiance, si chacun·ne peut consulter librement le code, si celui-ci n'a plus de secret, l'utilisateur n'a plus besoin de faire confiance.  
		...
		\item [P2P: ] Littéralement le pair à pair. L'échange de pair à pair des informations sans passer par un tiers, permet de se passer de la question du tiers de confiance. Les échanges sont reccueilli sur un annuaire. C'est le principe du blockchain.
	\end{description}
...
En 2014 la cour des comptes déplore que Pôle Emploi n'a pas suffisament d'information pour évaluer l'ampleur de la fraude. Aujourd'hui pôle emploi test dans plusieurs régions française, la possibilité de traquer les demandeur d'emploi en scannant les ip afin de connaitre d'où se connecte le demandeur d'emploi. 
En mai 2015 un projet de loi est déposé par le gouvernement sur le projet de loi relatif au dialogue social, comprennant la possibilité donnée à pôle emploi d'avoir accès aux relevé banquaires, relevé téléphonique,et donnée de géolocalisation, détenues par certaines entreprises privée. Finalement celui-ci à retiré l'ammendement concernant le relevé banquaire. (le tout sans controle judiciaire). 
...
Les entreprises privées sont coincée entre leur client, qui souhaiterai plus d'intimité et être moins \textit{"fliquées"} et la loi qui impose au opérateur une transmission d'information, plus fine. 

Le cas gandi est un exemple interessant car, au moment ou sort le projet de loi renseignement, visant à installer des boites noir chez les opérateur du réseau informatique, afin de reccueillir toute les informations qui passent sur le réseau. Face à se projet d'obligation légale, gandi monte au créneau et s'oppose frontalement à la loi. Cette opération de communication a marqué les esprits, et à consolider la confiance que les consommateur avait dans leur hébergement. 

Il s'agirait alors pour les entreprises privée d'être vigilante sur les projets et propositions de loi, de communiquer sur leur opposition et d'activer le lobbying contre ces loi visant à restreindre un certain nombre de liberté de leur utilisateur. 
